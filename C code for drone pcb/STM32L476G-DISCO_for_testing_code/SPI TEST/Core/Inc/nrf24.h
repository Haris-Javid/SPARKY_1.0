...
//#define nRF24_CMD_LOCK_UNLOCK      (uint8_t)0x60 // Lock/unlock exclusive features (dont see this any where in data sheet)
...
// // Dynamic Payload Length (DPL) control for FEATURE register
enum {
	nRF24_DPL_ON = ((uint8_t)(0x04)), // ENABLE DPL
	nRF24_DPL_OFF = ((uint8_t)(0x00))  // DISABLE DPL
} ;
